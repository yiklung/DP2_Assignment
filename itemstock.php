...
<body>
<h1>Item Stock Page</h1>
    
<form action="itemstockdata.php" method="post">
    Item Name:<br>
...
//Form validation
    if(isset($_POST['Login']))
    {
		...
		$itemstock=$_POST['itemstock'];	validate_form($itemname,$itemprice,$itemstock);
		echo"<br><br>";
    }

    function validate_form(($itemname,$itemprice,$itemstock){
        if(empty($itemname)){
			echo "Please enter the item name";
        }else if(empty($itemprice)){
			echo "Please enter the item price";
        }else{
			echo "Please enter the item stock"; 
        }
    }
